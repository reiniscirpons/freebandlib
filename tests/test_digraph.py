...
def test_digraph_reverse(digraph: DigraphAdjacencyList,
                         reverse_digraph: DigraphAdjacencyList):
...
@pytest.mark.parametrize("digraph,start,is_reachable",
                         [([], [], []),
                          ...
                          ([[0, 1], [0, 2, 2, 5], [3, 3], [2, 2, 3], [1], []],
                           [2, 5], [False, False, True, True, False, True])
                          ])
def test_digraph_is_reachable(digraph: DigraphAdjacencyList,
